  ...
  const patients = [
    {
      ...
      aiSummary:
        "Patient reports headache, dizziness, and fatigue. Elevated heart rate and slight fever detected. Working in high-temperature environment (38°C). AI recommends immediate hydration and rest.",
      symptoms: ["Headache", "Dizziness", "Fatigue", "Elevated HR"],
      workEnvironment: "Construction Site - High Heat Index",
      aiRecommendation:
        "Immediate rest in cool environment, electrolyte replacement, monitor for heat exhaustion progression",
    },
    {
      id: 2,
      name: "Priya Sharma",
    ...
    },
    {
      ...
      aiSummary:
        "Reports shortness of breath and mild chest tightness. Working in dusty environment. Oxygen saturation slightly below normal at 94%.",
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 lg:gap-0">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4">
            ...
            <Badge className="glass-card bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 border border-red-300 dark:border-red-600 shadow-md">
              <AlertTriangle className="w-3 h-3 mr-1" />2 Urgent Cases
            </Badge>
            <Button
              onClick={onLogout}
              variant="outline"
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex space-x-3">
                        <Button
                          onClick={() => alert("Treatment approved for " + selectedPatientData.name)}
                          className="flex-1"
                        >
                      ...
                      <div className="flex space-x-3">
                        <Button
                          onClick={() => alert("Starting video call with " + selectedPatientData.name)}
                          variant="outline"
                          size="sm"
                        >
                        ...
                        <Button
                          onClick={() => alert("Starting audio call with " + selectedPatientData.name)}
                          variant="outline"
                          size="sm"
                        >
                        ...
                        <Button
                          onClick={() => alert("Scheduling follow-up for " + selectedPatientData.name)}
                          variant="outline"
                          size="sm"
                        >
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center space-x-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                    ...
                    <Button onClick={() => setSelectedPatient(1)} size="sm" className="ml-auto">
                      Review
                    </Button>
                  </div>
