  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      type: "ai",
      content:
        "Hello Rajesh! I'm your Praana AI health assistant. I see your heart rate is elevated to 94 bpm. How are you feeling right now?",
      ...
      return [
        {
          type: "ai",
          content:
            "I understand you're experiencing symptoms that could be related to dehydration or heat stress. Let me take immediate action to help you.",
        },
        {
          type: "action",
          content: "",
        ...
        },
        {
          type: "ai",
          content:
            "I've automatically alerted your supervisor and booked an urgent consultation. Please find a cool, shaded area and rest immediately. Drink water slowly.",
        },
      ]
    }
    ...
    if (userInput.includes("pain") || userInput.includes("chest") || userInput.includes("difficulty")) {
      return [
        ...
        },
        {
          type: "ai",
          content:
            "Emergency services have been contacted. Please stay calm and remain where you are. Help is on the way.",
        },
      ]
    }
    ...
    return [
      {
        type: "ai",
        content:
          "Thank you for sharing that with me. Based on your current vitals and symptoms, I'm analyzing the best course of action.",
      },
      {
        type: "action",
        content: "",
      ...
      },
      {
        type: "ai",
        content:
          "I've set up a health monitoring plan for you. Please continue to stay hydrated and take breaks in shaded areas.",
      },
    ]
  }
          ...
          {messages.map((message) => (
            ...
            >
              {message.type === "user" ? (
                ...
                <motion.div initial={{ scale: 0.8 }} animate={{ scale: 1 }} className="max-w-sm sm:max-w-md">
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          <h4 className="font-medium text-orange-700 dark:text-orange-300 text-responsive-sm">
                            {message.action.title}
                          </h4>
                          <p className="text-responsive-xs text-foreground/80 mt-1">{message.action.description}</p>
                          <Badge
                            variant="secondary"
                            className="mt-2 text-responsive-xs bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 border-orange-300 dark:border-orange-600"
                          >
                            Auto-executed by AI
                          </Badge>
                        </div>
        ...
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
          <div className="flex-1 flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2">
            ...
            <Button
              size="sm"
              variant="outline"
              className="sm:w-auto w-full border-primary/30 text-primary hover:bg-primary/10 bg-transparent"
            >
