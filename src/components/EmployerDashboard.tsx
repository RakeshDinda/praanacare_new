      ...
      <div className="glass-card border-b border-primary/20 p-3 sm:p-4 pt-16 sm:pt-20">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 lg:gap-0">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-responsive-lg sm:text-responsive-xl text-foreground text-glow">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4">
            <Button
              onClick={() => alert("Exporting health report...")}
              variant="outline"
              size="sm"
            ...
            <Button
              onClick={() => alert("Scheduling health review meeting...")}
              size="sm"
                  ...
                  <div className="flex items-start space-x-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-red-700 mt-1">
                        Heat index will reach dangerous levels (40°C) between 2-4 PM. Recommend moving outdoor
                        construction tasks to morning hours (6-10 AM).
                      </p>
                    ...
                    <Button onClick={() => alert("Implementing schedule change...")} size="sm">
                      Implement
                    </Button>
                  </div>
                  ...
                  <div className="flex items-start space-x-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-yellow-700 mt-1">
                        Analysis shows workers in Zone C are 40% more likely to experience dehydration. Add 3 additional
                        hydration stations.
                      </p>
                      <div className="flex items-center space-x-2 mt-2">
                        <Badge variant="outline" className="text-xs">
                    ...
                    <Button
                      onClick={() => alert("Reviewing hydration station proposal...")}
                      size="sm"
                      variant="outline"
                    >
                      Review
                  ...
                  <div className="flex items-start space-x-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-blue-700 mt-1">
                        AI suggests staggered 15-minute cooling breaks every 2 hours for manufacturing teams to reduce
                        fatigue incidents by 25%.
                      </p>
                      <div className="flex items-center space-x-2 mt-2">
                        <Badge variant="outline" className="text-xs">
                          Estimated savings: $12K/month
                        </Badge>
                      </div>
                    </div>
                    <Button onClick={() => alert("Scheduling break optimization...")} size="sm" variant="outline">
                      Schedule
                    </Button>
                  </div>
                </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center space-x-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                    ...
                    <Button
                      onClick={() => alert("Responding to heat alert...")}
                      size="sm"
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    ...
                    <Button onClick={() => alert("Monitoring manufacturing incidents...")} size="sm" variant="outline">
                      Monitor
                    </Button>
                  </div>
                </div>
